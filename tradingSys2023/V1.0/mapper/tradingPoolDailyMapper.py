...
def init():
    mongod_con = mu.db_connection("trading_pool_daily")
    return mongod_con

def find_all_from_mongodb_with_sortCon(sortCon):
    mongod_con = init()
...
# tradingPoolCon = {}
# tradingPoolCon['tradingDay'] = '2023-04-04'
# tradingPoolCon['mon1'] = '05'
# tradingPoolCon['mon2'] = '07'
# tradingPoolList = find_from_mongodb_with_condition(tradingPoolCon,'createTime')
# print(tradingPoolList)
#
# for tradingPoolData in tradingPoolList:
#     tradingPoolDataStr = tradingPoolData['productName'] + '\t\t' + \
...
#                          str(tradingPoolData['futureBasis']) + '\t\t' + \
#                          str(tradingPoolData['spread']) + '\t\t' + \
#                          str(tradingPoolData['ratio'])
#     print(tradingPoolDataStr)