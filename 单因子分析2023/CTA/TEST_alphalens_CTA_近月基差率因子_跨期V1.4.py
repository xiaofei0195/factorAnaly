...
if __name__ == '__main__':
    ...
    ########################################################
    '''
    raw_price = pd.read_csv('../DB/CSV导出/跨期价差/MONGO_09_跨期价差.csv')
    ...
    # 指定近月合约价格
    # 读取指定日期区间、指定品种
    monPriceDf = pd.read_csv('../DB/CSV导出/指定合约价格/掘金_09合约价格2023-01-01TO2023-09-05.csv')
    ...
    # 优化读取和合并csv文件
    file_paths = [
        '../FACTOR/2023-04-01 TO 2023-08-31近月基差率因子09_ALL.csv'
    ]
