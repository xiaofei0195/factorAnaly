...
if __name__ == '__main__':
    ...
    win_price_value = filtered_price_df.loc[:,['date', 'asset','cumulative_return']].groupby('date', 'asset').apply(lambda x: winsor(x[column_name]))
    win_price_value['return_wined'] = win_price_value.values
